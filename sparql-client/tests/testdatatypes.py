...
class TestTypedLiterals(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        l = sparql.Literal(u'Hello world',
                           u'http://www.w3.org/2001/XMLSchema#string')
        self.assertEqual(u'<Literal "Hello world"^^<http://www.w3.org/2001/XMLSchema#string>>'
                         , repr(l))
    ...
    def test_literal_same(self):
        ...
        l1 = sparql.Literal(u'Hello world',
                            u'http://aims.fao.org/aos/geopolitical.owl#MillionUSD'
                            )
        l2 = sparql.Literal(u'Hello world',
                            u'http://aims.fao.org/aos/geopolitical.owl#MillionUSD'
                            )
        self.assertEqual(l1, l2)
    ...
    def test_literal_notsame2(self):
        ...
        l2 = sparql.Literal(u'Hallo Welt',
                            u'http://aims.fao.org/aos/geopolitical.owl#MillionUSD'
                            )
        self.assertNotEqual(l1, l2)
    ...
    def test_convert_to_unicode(self):
        ...
        if six.PY2:
            lt = sparql.Literal(SomeType(),
                                u'http://aims.fao.org/aos/geopolitical.owl#MillionUSD'
                                )
        else:
            lt = sparql.Literal(SomeType().__unicode__(),
                                u'http://aims.fao.org/aos/geopolitical.owl#MillionUSD'
                                )
...
class TestNotation3(unittest.TestCase):
    ...
    def test_literal(self):
        ...
        for (value, expected) in _literal_data:
            ...
            self.assertEqual(sparql.Literal(value, lang='en').n3(),
                             expected + '@en')
